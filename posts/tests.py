...
class ProfileTest(TestCase):
    def setUp(self):
        ...
        self.James = Profile(user = self.james,user_id=1,bio = 'my hood', email='james@gmail.com',profile_pic = 'image.jpg',location='Mombasa', neighbourhood='Kilimani')
...
class BusinessTestCase(TestCase):
    self.new_neighborhood= Project(name = 'market',user = 'James',email = 'james@gmail',neighborhood = 'Garissa',descrption='serenity at its best')
